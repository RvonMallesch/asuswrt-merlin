...
#export DSL-AC68U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                    SAMBA3=y MEDIASRV=y MODEM=y MODEMPIN=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y \
                    WEBDAV=y CLOUDSYNC=y USB="USB" GRO=y APP="installed" BUILD_NAME="DSL-AC68U" PROXYSTA=y FTPCLIENT=y SAMBACLIENT=y \
                    DNSMQ=y SHP=y NVRAM_64K=y DSLAC68U=y BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=y \
                    ...
                    DSL=y DSL_TCLINUX=y VDSL=y USER_LOW_RSSI=y HFS=y TCPDUMP=y EMAIL=y

export DSL-AC68U := ACCEL_PPTPD=y ADBLOCK=n APP="nolocaldm" ARM=y AUTODICT=y BBEXTRAS=y BCM_RECVFILE=y BCM4352_5G=y BCM5301X_TRAFFIC_MONITOR=y \
                    BCM5301X=y BCM57=y BCM7=n BCMFA=y BCMSMP=y BCMWL6=y BCMWL6A=y BECEEM=y BRCM_NAND_JFFS2=y BTN_WIFITOG=y BTN_WPS_ALLLED=y \
                    BUILD_NAME="DSL-AC68U" BWDPI=y CLOUDCHECK=y CLOUDSYNC=y CTF_PPTP_L2TP=y DEBUGFS=y DISK_MONITOR=y \
                    DNSFILTER=y DNSMQ=y DROPBOXCLIENT=y DSL_TCLINUX=y DSL=y DSLAC68U=y DUALWAN=y DUMP_OOPS_MSG=y EBTABLES=y EMAIL=y \
                    FTPCLIENT=y GRO=y HFS="tuxera" HSPOT=y HTTPS=y IPSEC=n IPV6SUPP=y JFFS2=y JFFS2LOG=y JFFS2USERICON=y \
                    LINUX_MTD="64" MDNS=y MEDIASRV=y MODEM=y MODEMPIN=y MULTICASTIPTV=y NANO=y NATNL=y NFS=y NTFS="tuxera" NVRAM_64K=y ODMPID=y \
                    OPENVPN=y OPTIMIZE_XBOX=y PARENTAL2=y PRINTER=y PROXYSTA=y QUAGGA=y REBOOT_SCHEDULE=y SAMBA3=y SAMBA36=y SAMBACLIENT=y \
                    SHP=y SNMPD=y SSD=n SSH=y STAINFO=y SWEBDAVCLIENT=y TCPDUMP=y TEMPROOTFS=y TFAT=y TIMEMACHINE=y TOR=y TUNEK="n" \
                    TURBO=y UPNPIGD2=n USB="USB" USBEXTRAS=y USER_LOW_RSSI=y VDSL=y VPNC=y WEBDAV=y XHCI=y XHCIMODE=y \
                    FAKEHDR=y FORCE_SN=380 FORCE_EN=1031
