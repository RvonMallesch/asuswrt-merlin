...
export DSL-AC68U := ACCEL_PPTPD=y ADBLOCK=n APP="nolocaldm" ARM=y AUTODICT=y BBEXTRAS=y BCM4352_5G=y BCM5301X_TRAFFIC_MONITOR=y \
                    BCM5301X=y BCM57=y BCM7=n BCMFA=y BCMSMP=y BCMWL6=y BCMWL6A=y BECEEM=y BRCM_NAND_JFFS2=y BTN_WIFITOG=y \
                    ...
                    FTPCLIENT=y GRO=y HFS="tuxera" HTTPS=y IPSEC=n IPV6SUPP=y JFFS2=y JFFS2LOG=y JFFS2USERICON=y BTN_WPS_ALLLED=y \
                    LINUX_MTD="64" MDNS=y MEDIASRV=y MODEM=y MODEMPIN=y NATNL=y NFS=y NTFS="tuxera" NVRAM_64K=y ODMPID=y \
                    OPENVPN=y OPTIMIZE_XBOX=y PARENTAL2=y PRINTER=y PROXYSTA=y REPEATER=y ROG=y SAMBA3=y SAMBA36=y SAMBACLIENT=y \
